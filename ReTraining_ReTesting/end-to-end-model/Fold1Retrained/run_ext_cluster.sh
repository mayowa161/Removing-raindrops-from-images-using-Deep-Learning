...
#SBATCH --output=/users/lady6758/Mayowa_4YP_Code/ReTraining_ReTesting/end-to-end-model/Fold1Retrained/cluster_outputs/%j.out
#SBATCH --gres gpu:1
...
cd /users/lady6758/Mayowa_4YP_Code/ReTraining_ReTesting/end-to-end-model/Fold1Retrained

echo "CUDA_VISIBLE_DEVICES = $CUDA_VISIBLE_DEVICES"

USER="lady6758"
PROJECT_PATH="/users/lady6758/Mayowa_4YP_Code/ReTraining_ReTesting/end-to-end-model/Fold1Retrained"
export LD_LIBRARY_PATH=$(conda info --base)/envs/Mayowa_code_env/lib:$LD_LIBRARY_PATH
export TF_GPU_ALLOCATOR=cuda_malloc_async
python ${PROJECT_PATH}/mean_calc.py
