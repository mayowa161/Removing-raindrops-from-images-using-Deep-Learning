...
np.save('/users/lady6758/Mayowa_4YP_Code/ReTraining_ReTesting/Raindrop_Mask/RWRetrained/history.npy',history.history)

model.save_weights(filepath = '/users/lady6758/Mayowa_4YP_Code/ReTraining_ReTesting/Raindrop_Mask/RWRetrained/attentionweights.weights.h5')
