...
#SBATCH --job-name=RWAttentionModule
#SBATCH --output=/users/lady6758/Mayowa_4YP_Code/ReTraining_ReTesting/Raindrop_Mask/cluster_outputs/%j.out
#SBATCH --gres=gpu:1
...
USER="lady6758"
PROJECT_PATH="/users/lady6758/Mayowa_4YP_Code/ReTraining_ReTesting/Raindrop_Mask"
# Run the actual script
export LD_LIBRARY_PATH=$(conda info --base)/envs/Mayowa_code_env/lib:$LD_LIBRARY_PATH
python ${PROJECT_PATH}/AttentionModuleRW.py
