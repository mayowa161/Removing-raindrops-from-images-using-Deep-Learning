...
#SBATCH --job-name=ValGAN
#SBATCH --output=/users/lady6758/Mayowa_4YP_Code/ReTraining_ReTesting/GAN/cluster_outputs/%j.out
#SBATCH --gres=gpu:2
...
USER="lady6758"
PROJECT_PATH="/users/lady6758/Mayowa_4YP_Code/ReTraining_ReTesting/GAN"
# Run the actual script
export LD_LIBRARY_PATH=$(conda info --base)/envs/Mayowa_code_env/lib:$LD_LIBRARY_PATH
export TF_GPU_ALLOCATOR=cuda_malloc_async
python ${PROJECT_PATH}/ValGAN.py
